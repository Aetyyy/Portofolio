...
export default function Page() {
  return (
    <main>
      ...
      <section
        id="skills"
        className="mb-96 container mx-auto px-4 md:px-8 lg:px-16 bg-abu rounded-apalah shadow-lg"
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-[18rem] bg-slate-100 rounded-full h-5 mb-4 relative">
              <div
                className="bg-kuning h-5 rounded-full flex items-center justify-end pr-2"
                style={{ width: "50%" }}
              >
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-[18rem] bg-slate-100 rounded-full h-5 mb-4 relative">
              <div
                className="bg-biru h-5 rounded-full flex items-center justify-end pr-2"
                style={{ width: "50%" }}
              >
                <span className="text-xs font-semibold text-white">50%</span>
              </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-[18rem] bg-slate-100 rounded-full h-5 mb-4 relative">
              <div
                className="bg-red-600 h-5 rounded-full flex items-center justify-end pr-2"
                style={{ width: "25%" }}
              >
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-[18rem] bg-slate-100 rounded-full h-5 mb-4 relative">
              <div
                className="bg-tlwnd h-5 rounded-full flex items-center justify-end pr-2"
                style={{ width: "50%" }}
              >
                <span className="text-xs font-semibold text-white">50%</span>
              </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-[18rem] bg-slate-100 rounded-full h-5 mb-4 relative">
              <div
                className="bg-react h-5 rounded-full flex items-center justify-end pr-2"
                style={{ width: "30%" }}
              >
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-[18rem] bg-slate-100 rounded-full h-5 mb-4 relative">
              <div
                className="bg-black h-5 rounded-full flex items-center justify-end pr-2"
                style={{ width: "30%" }}
              >
                <span className="text-xs font-semibold text-white">30%</span>
              </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-[18rem] bg-slate-100 rounded-full h-5 mb-4 relative">
              <div
                className="bg-npm h-5 rounded-full flex items-center justify-end pr-2"
                style={{ width: "30%" }}
              >
                <span className="text-xs font-semibold text-white">30%</span>
              </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-[18rem] bg-slate-100 rounded-full h-5 mb-4 relative">
              <div
                className="bg-nodejs h-5 rounded-full flex items-center justify-end pr-2"
                style={{ width: "30%" }}
              >
                <span className="text-xs font-semibold text-white">30%</span>
              </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-[18rem] bg-slate-100 rounded-full h-5 mb-4 relative">
              <div
                className="bg-python h-5 rounded-full flex items-center justify-end pr-2"
                style={{ width: "15%" }}
              >
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-[18rem] bg-slate-100 rounded-full h-5 mb-4 relative">
              <div
                className="bg-html5 h-5 rounded-full flex items-center justify-end pr-2"
                style={{ width: "50%" }}
              >
                <span className="text-xs font-semibold text-white">50%</span>
              </div>
          ...
          <div className="flex flex-col items-center ">
            ...
            <div className="w-full max-w-[18rem] bg-slate-100 rounded-full h-5 mb-4 relative">
              <div
                className="bg-css3 h-5 rounded-full flex items-center justify-end pr-2"
                style={{ width: "50%" }}
              >
                <span className="text-xs font-semibold text-white">50%</span>
              </div>
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <div className="w-full max-w-[18rem] bg-slate-100 rounded-full h-5 mb-4 relative">
              <div
                className="bg-git h-5 rounded-full flex items-center justify-end pr-2"
                style={{ width: "50%" }}
              >
                <span className="text-xs font-semibold text-white">50%</span>
              </div>
